...
const translations = {
  ar: {
    ...
    hero_subtitle: 'GRILL & KIOSK<br>الفروج على حطب الزيتون.. طعم النار الأصيل<br>أرقى الجلسات العائلية في طولكرم',
    btn_menu: 'تصفح القائمة',
    section_story: 'عراقة المكان وفخامة الطعم',
    story_p1: 'في قلب طولكرم، أعددنا لكم مكاناً يجمع بين خصوصية الجلسات العائلية وفخامة الضيافة. نستخدم حطب الزيتون الطبيعي لنمنح الفروج تلك النكهة المدخنة الأصيلة.',
    story_p2: 'شيكن ماستر ليس مجرد مطعم، بل هو وجهتكم المفضلة لجلسة راقية هادئة، حيث التصميم الكلاسيكي والأجواء الدافئة تضمن لكم أجمل الأوقات مع عائلاتكم.',
    story_quote: '"القعدة الفخمة.. والطعم اللي بيحكي قصة"',
    ...
    step1Desc: 'املأ النموذج واحصل على كوبون خصم فريد 10%',
    step2Title: 'اطلب باستخدام الكوبون',
    step2Desc: 'استخدم كوبونك عند طلب وجبتك المفضلة',
    step3Title: 'ادخل السحب',
    step3Desc: 'تلقائياً تدخل سحب 100 شيكل!',
    raffleTitle: 'السحب على 100 شيكل',
    raffleDesc: 'سيتم السحب في نهاية رمضان 2026',
    termsTitle: 'الشروط والأحكام',
    terms: [
      'يجب متابعة صفحاتنا على السوشال ميديا',
      'كل شخص يحصل على كوبون واحد فقط',
      'الكوبون صالح حتى نهاية رمضان',
      'يجب شراء وجبة واحدة على الأقل للدخول في السحب',
      'السحب عشوائي وعادل للجميع'
    ],

    // Registration Page - New Steps
    steps_title: 'خطوات الربح 🏆',
    steps_subtitle: 'اتبع الخطوات البسيطة التالية لدخول السحب',

    step_follow_title: 'تابعنا على السوشال ميديا',
    step_follow_desc: 'شرط أساسي لدخول السحب',
    btn_instagram: 'تابع انستقرام',
    btn_facebook: 'تابع فيسبوك',
    social_hint: 'يرجى متابعة الصفحتين لتفعيل زر التسجيل',

    step_register_title: 'سجل بياناتك',
    step_register_desc: 'للحصول على كود الخصم الخاص بك',
    input_name_placeholder: 'الاسم الكامل',
    input_phone_placeholder: 'رقم الجوال (059xxxxxxx)',
    btn_submit_raffle: 'تسجيل والحصول على الكوبون',

    step_coupon_title: 'استلم كوبون 10%',
    step_coupon_desc: 'سيظهر لك كود خصم فوري بعد التسجيل',

    step_raffle_title: 'اطلب وادخل السحب',
    step_raffle_desc: 'استخدم الكوبون في مطعمنا لتدخل السحب على <strong>100 شيكل</strong>',

    back_home: '← العودة للرئيسية',

    // Registration Form (Existing)
    registerTitle: 'التسجيل في السحب',
    registerSubtitle: 'املأ البيانات للحصول على كوبونك',
    followUs: 'تابعنا على السوشال ميديا',
    followInstagram: 'تابع على انستقرام',
    ...
    // Store & Menu
    storeTitle: 'القائمة',
    hero_subtitle: 'تذوق الفخامة في كل وجبة',
    ...
    item_greek_desc: 'خيار، طماطم، بصل، زيتون، جبنة فيتا.',

    // Notes
    notesPlaceholder: 'ملاحظات الطلب (اختياري)',
    itemNotePlaceholder: 'ملاحظات للصنف...',
  ...
  en: {
    ...
    hero_subtitle: 'GRILL & KIOSK<br>The Art of Olive Wood Grilling.. Authentic Smoky Taste<br>Premium Family Seating in Tulkarm',
    btn_menu: 'Browse Menu',
    section_story: 'Heritage Meets Luxury',
    story_p1: 'In the heart of Tulkarm, we created a place that combines family privacy with luxurious hospitality. We use natural olive wood to give the chicken its authentic smoky flavor.',
    story_p2: 'Chicken Master is more than just a restaurant; it is your preferred destination for a sophisticated, quiet gathering, where classic design and warm vibes guarantee the best times with your family.',
    story_quote: '"Elegant Seating.. Taste that Tells a Story"',
      ...
      if (response.ok && response.data.success) {
        ...
        if (couponData.status === 'used') {
          ...
          if (msg) {
            msg.style.display = 'block';
            msg.style.color = '#E74C3C';
            msg.textContent = langManager.getCurrentLang() === 'ar' ? 'الكوبون مستخدم مسبقاً' : 'Coupon already used';
          }
          ...
          if (msg) {
            msg.style.display = 'block';
            msg.style.color = '#E74C3C';
            msg.textContent = langManager.getCurrentLang() === 'ar' ? 'الكوبون منتهي الصلاحية' : 'Coupon expired';
          }
        } else {
          // Valid
